...
## UI Contract
- [ ] Dealer table remains primary action area.
- [ ] User instruction ("what to do next") is clearly visible near bet CTAs.
...
- [ ] No random theme drift outside project style.
- [ ] Desktop and mobile both remain usable and readable.
